...
# Power BI Setup
Extract: Ran the MasterFinancials SQL query to import a flattened, high-performance dataset.

Transform: Used DAX to create dynamic measures for Total Revenue, Total Margin %, and ROI.
